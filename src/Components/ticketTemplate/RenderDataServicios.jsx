  ...
  <>
    <div className="info-section">
      <div className="info-column">
        ...
        <p><strong>Nombre de ESS</strong>: {editableData.serviceRequest?.essName}</p>
        ...
        <p><strong>Afiliación</strong>: {editableData.serviceRequest?.affiliation}</p>
        <p><strong>Afiliado ATPV</strong>: {editableData.serviceRequest?.atpvAffiliate}</p>
        <p><strong>ID ATPV</strong>: {editableData.serviceRequest?.atpvID}</p>
      </div>
      <div className="info-column">
        <p><strong>Contrato relacionado</strong>: {editableData.contactInfo?.relatedContract}</p>
        <p><strong>Cliente</strong>: {editableData.contactInfo?.client}</p>
        <p><strong>Persona de contacto (Creador)</strong>: {editableData.contactInfo?.contactPerson?.creator}</p>
        <p><strong>Persona de contacto (Supervisor)</strong>: {editableData.contactInfo?.contactPerson?.supervisor}</p>
    ...
    <div className="full-width-section">
      <p><strong>Motivo del Servicio</strong>: {editableData.serviceRequest?.serviceReason}</p>
    </div>
    <div className="full-width-section">
      <p><strong>Motivo real del Servicio en sitio</strong>: {editableData.serviceDetails?.onSiteReason}</p>
